...
// import PageInteractions from "../utilities/page-interactions";
// const page =new PageInteractions 
// Cypress.Commands.add("LogIn", (watchlistData) => {
//     page.writeTxt(watchlistData.username.selector, watchlistData.username.name);
//     page.writeTxt(
//       watchlistData.password.selector,
//       watchlistData.password.passwordValue
//     );
//     page.clickBtn(watchlistData.login.loginBtn)
//   });
